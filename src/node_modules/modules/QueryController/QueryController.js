...
export default class QueryController {
  ...
  async loadObjectsWithPage(page, clear) {
    try {
  ...
  loadNextPage = () => {
    if (!this[kStateKey].loading) {
      return this.loadObjectsWithPage(this[kStateKey].currentPage + 1, false);
    }
  ...
  loadPrevPage = () => {
    if (!this[kStateKey].loading) {
      return this.loadObjectsWithPage(Math.max(this[kStateKey].currentPage - 1, 0), false);
    }
    return Promise.reject('The queryController is busy');
  };
