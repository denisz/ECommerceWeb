...
export default () => (
  <div className="Shipment">
    ...
    <p>
      <Image src="ic_post_russia.jpg" className="Shipment-image"/> На все розничные заказы распространяется бесплатная доставка первым Почты России.
      <br/> Сроки доставки варьируются от 7 до 12 дней.
    </p>
    <h3 className="display-3">Экспресс доставка</h3>
    <p>
      <Image src="ic_post_middle.jpg" className="Shipment-image"/> Возможна отправка заказа такими службами экспресс доставки, как: EMS.
    ...
    <p>
      <Image src="ic_post_big.jpg" className="Shipment-image"/> Отправка оптовых заказов осуществляется любой транспортной компанией на выбор.
